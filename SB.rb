...
module SBa
  ...
  class Particle
    ...
    def make_body(x, y, r)
      ...
      body.set_linear_velocity(SBa::Vec2.new(-10 + rand(20), 5 + rand(5)))
      body.set_angular_velocity(-10 + rand(20))
    end
  end
end
